...
CTFd is an awesome capture the flag framework. This charm will deploy the framework
and setup the flags that are bundled with [juju-ctf](github.com/oparkins/juju-ctf)
